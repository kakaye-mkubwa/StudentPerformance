            ...
            <form role="form">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="courseInput" placeholder="Enter Course Code">
                </div>
                <div class="form-group">
                  <label for="periodInput">Period</label>
                  <input type="text" class="form-control" id="periodInput" placeholder="Enter Period">
                </div>
              </div>
              <!-- /.card-body -->
...
$(document).ready(function () {
  ...
  $('#submit-button').on('click',function (e) {
    ...
    let courseInput = $('#courseInput').val();
    let periodInput = $('#periodInput').val();

    console.log(courseInput);
    console.log(periodInput);
    $.ajax({
      url:'ajax/list-performance-ajax.php',
      type:'POST',
      data:{courseInput:courseInput,periodInput:periodInput}
    }).done(function (data) {
