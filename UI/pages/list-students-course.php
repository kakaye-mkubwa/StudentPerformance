            ...
            <form role="form">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="courseCodeInput" placeholder="Enter Course Code">
                </div>
              </div>
              <!-- /.card-body -->
...
$(document).ready(function () {
  ...
  $('#submit-button').on('click',function (e) {
    ...
    let courseInput = $('#courseCodeInput').val();

    // console.log(courseInput);

    $.ajax({
      url:'ajax/list-students-course-ajax.php',
      type:'POST',
